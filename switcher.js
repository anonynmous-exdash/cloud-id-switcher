...
if(!vm)var vm = document.getElementById("app")._reactRootContainer._internalRoot.current.child.pendingProps.store.getState().scratchGui.vm;
...
console.log("%c Succesfully switched cloud ID", "font-size:40px;")
    ...
    console.error(err)
    console.log("%c Something went wrong when switching cloud ID", "font-size:40px;")
}
})()
